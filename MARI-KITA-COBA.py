...
for y in range(threads):
    ...
    th2 = threading.Thread(target = Attack)
    th3 = threading.Thread(target = Attack)
    th4 = threading.Thread(target = Attack)
    th5 = threading.Thread(target = Attack)
    th6 = threading.Thread(target = Attack)
    th7 = threading.Thread(target = Attack)
    th8 = threading.Thread(target = Attack)
    th9 = threading.Thread(target = Attack)
    th.start()
    th2.start()
    th3.start()
    th4.start()
